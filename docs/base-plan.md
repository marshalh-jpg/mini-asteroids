...
- [ ] **Server skeleton and protocol.** Add `src/game.js` with a `Game`
...
- [ ] **Ship physics and input.** Add rotate-left, rotate-right, thrust,
...
- [ ] **Asteroids.** Add asteroid spawn at game start (fixed count),
...
- [ ] **Bullets, collisions, scoring, lives.** Add bullet movement and a
...
- [ ] **Client rendering and input capture.** Update `public/game.js` to
